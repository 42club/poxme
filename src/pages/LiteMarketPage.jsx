...
import { TrendingUp, Sparkles, BarChart2, Info, House } from 'lucide-react'
...
// MARKET PAGE
// ════════════════════════════════════════════════════════════════════════
export default function LiteMarketPage() {
    ...
    <div className="lite-root">
      ...
      <header className="lt-header">
        ...
        <div className="lt-header-end">
          <Link className="lt-header-idx-btn" to="/lite" title="Lite home">
            <House size={15} />
          </Link>
          {myAgent && (
            <>
          ...
          <WalletButton
            onCreateAgent={() => {
              if (typeof window !== 'undefined') window.location.assign('/lite')
            }}
            hasAgent={!!myAgent}
